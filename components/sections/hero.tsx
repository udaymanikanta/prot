        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-lg">
              ...
              DevOps pipelines, and AI-powered platforms using AWS,
              Docker, Kubernetes, Jenkins, Next.js, FastAPI,
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                <a
                  href="https://drive.google.com/file/d/1MubHdqchFWTez16ayDJkoEQZDdXykwDN/view?usp=drive_link"
                  target="_blank"
